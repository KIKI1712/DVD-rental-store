...
#Since my name is Kerim Masovic if would like to se all customers whose name starts with Ke OR last name starts with Ma
SELECT * FROM customer
WHERE first_name LIKE "Ke%" OR last_name LIKE "Ma%";
...
#TOP 5 genre
SELECT name AS genre, COUNT(*) AS number_of_movies_made, 
